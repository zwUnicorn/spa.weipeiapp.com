<template>
    <div class="wrapper" :class="[isBottom ? 'bottomOne':'bottomTwo']">
        ...
        <div class="list" ref="list">
            ...
            <pause v-if="isPause" :pause="pause" @cancel="cancle" @getId="getId" class="position"></pause>
        ...
        <div class="title">
            <div class="titleBox">
                ...
                <div class="filtrate" @click="unfold(2)">
                    <text class="text">{{getTitle}}</text>
                    <image :src="arrowDown" class="image" resize="contain" ref="arrowThree"></image>
                </div>
            </div>
        </div>
    </div>
